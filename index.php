...
<body>
    <header class="header">
        <ul>
            ...
            <li> <a class="underlineHover" href="">Mijn Recepten</a> </li>
        </ul>
    ...
    <div class="header--div">
        ...
        <button class="button">Plaats je recept!</button>
    </div>
            ...
            <article class="main--art">
                ...
                <div class="info">
                    ...
                    <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis accusamus provident consequatur iusto. Facilis aliquid soluta commodi maxime cum sapiente exercitationem, sint necessitatibus sed provident placeat, a reprehenderit quos possimus.
                        Ratione consequatur repellendus a eaque doloremque asperiores quos nihil magni commodi aliquid dolorum adipisci magnam minima non, eligendi aut nobis architecto officiis perferendis excepturi quasi obcaecati exercitationem et. Sapiente, repudiandae.
                    </p>
                </div>
                <div class="links">
                    <button class="button">Kook nu!</button>
